...
export default function App() {
  ...
  const clearFilters = () => { setFilterPriority('all'); setFilterSector('all'); setFilterCountry('all'); setFilterArea('all'); setFilterStatus('all'); setSearch('') }
  ...
  return <div className="app">
    ...
    </main><footer className="app-footer"><span>{filtered.length} of {placements.length} placements</span><span className="footer-live"><span className="footer-dot" /> Live database · status and new roles update automatically</span></footer>
  </div>
}
