...
export function sameRole(existing, placement) {
  return roleIdentity({ company: existing.company, title: existing.specific_role, city: existing.city }) ===
    roleIdentity({ company: placement.company, title: placement.specific_role, city: placement.city })
}
